...
class FanController extends CRUDCrontroller
{
    public function __construct(Request $request)
    {
        parent::__construct('User');
        $request->merge(["user_type"=>"fan"]);
        $this->__request    = $request;
        $this->__data['page_title'] = 'Fan';
        $this->__indexView  = 'fan.index';
        $this->__createView = 'fan.add';
        $this->__editView   = 'fan.edit';
        $this->__detailView = 'fan.detail';
    }
    ...
    {
        $options  = '<a href="'. route('fan-management.edit',['fan_management' => $record->slug]) .'" title="Edit" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></a> ';
