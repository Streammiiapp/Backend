...
//    }
    ...
    public static function  generateThumbnail($videoName,$path,$storage_path){
        ...
        //$videoThumbsStoreDIR = public_path(Config::get('constants.MEDIA_IMAGE_PATH'));
         $videoThumbsStoreDIR = $storage_path;
        $currentVideoPATH = $videoThumbsStoreDIR.$videoName;
        ...
        if($thumbnail_status){
            return '/storage/media-files/'.$newFileWithJPGExt;
        }else{
